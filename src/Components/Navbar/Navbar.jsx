...
const Navbar = () => {
  ...
  return (
    <div className='navbar'>
        <img src={logo} alt=''/>
        <img src={menu_open} onClick={openMenu} className='navopen' />
        <ul ref={menuRef} className="navmenu">
          <img src={menu_close} onClick={closeMenu} alt="" className="navclose" />
          ...
          <li><AnchorLink className='anchorlink' offset={50}  href='#service'><p onClick={()=>setMenu("service")}>Services</p></AnchorLink>{menu==="service"?<img src={underline} alt=''/>:<></>}</li>
        ...
        <div className="navconnect"><AnchorLink className='anchorlink' offset={50} href='#contact'>Connect With Me</AnchorLink></div>
    </div>
  )
}
